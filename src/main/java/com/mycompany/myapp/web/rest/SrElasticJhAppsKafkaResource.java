...
@RestController
@RequestMapping("/api/sr-elastic-jh-apps-kafka")
public class SrElasticJhAppsKafkaResource {

    private final Logger log = LoggerFactory.getLogger(SrElasticJhAppsKafkaResource.class);
    ...
    public SrElasticJhAppsKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
